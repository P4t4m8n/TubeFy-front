...
export function Note() {
    ...
    return (
        <svg className="note-svg" viewBox="0 0 24 24"><path d="M6 3h15v15.167a3.5 3.5 0 1 1-3.5-3.5H19V5H8v13.167a3.5 3.5 0 1 1-3.5-3.5H6V3zm0 13.667H4.5a1.5 1.5 0 1 0 1.5 1.5v-1.5zm13 0h-1.5a1.5 1.5 0 1 0 1.5 1.5v-1.5z"></path></svg>
    )
}

export function Pencil() {
    return (
        <svg className='pencil-svg' viewBox="0 0 24 24" >
...
export function ArrowBack() {
    return (
        <svg viewBox="0 0 16 16" >
            <path d="M8.81 1A.749.749 0 0 0 7.53.47L0 7.99l7.53 7.521a.75.75 0 0 0 1.234-.815.75.75 0 0 0-.174-.243L2.87 8.74h12.38a.75.75 0 1 0 0-1.498H2.87l5.72-5.713c.14-.14.22-.331.22-.53z">
            </path>
        </svg>
    )
}
...
export function HomeSvgClicked() {
    return (
        <svg viewBox="0 0 24 24">
...
export function SearchSvgClicked() {
    return (
        <svg viewBox="0 0 24 24">
...
export function Clock() {
    return (
        <svg viewBox="0 0 16 16" >
            ...
            </path><path d="M8 3.25a.75.75 0 0 1 .75.75v3.25H11a.75.75 0 0 1 0 1.5H7.25V4A.75.75 0 0 1 8 3.25z">
            </path>
        </svg>
    )
}
...
export function Forword() {
    return (
        <svg data-encore-id="icon" role="img" aria-hidden="true" class="Svg-sc-ytk21e-0 kgVuXA IYDlXmBmmUKHveMzIPCF" viewBox="0 0 16 16"><path d="M4.97.47a.75.75 0 0 0 0 1.06L11.44 8l-6.47 6.47a.75.75 0 1 0 1.06 1.06L13.56 8 6.03.47a.75.75 0 0 0-1.06 0z"></path></svg>
    )
}
...
export function VertDots() {
    return <svg viewBox="0 0 16 16" ><path d="M3 8a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm6.5 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zM16 8a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"></path></svg>
}
